...
import rainyWeather from '../../assets/rainy.png'

export default function TempInfo({ city, temperature, humidity, wind, weather }) {
  ...
  return (
    <div><div className="cardm">
      <div className="card">
        <img src={weatherIco} alt="" className='weather' />
      ...
      <div className="card2">
        <div className="upper">
          <div className="humidity">
            <div className="humiditytext">Humidade<br />{humidity}%</div>
      ...
      KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" y={0} x={0} height={30} width={30} id="image0" />
          ...
          <div className="air">
            <div className="airtext">Vento<br />{wind} Km/h</div>
